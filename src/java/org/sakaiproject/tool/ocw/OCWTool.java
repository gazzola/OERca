...
package org.sakaiproject.tool.ocw;
 ...
 * @version $Revision:  $
 */
public class OCWTool extends HttpServlet
{
	private static final String headHtml = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"> 		<html xmlns=\"http://www.w3.org/1999/xhtml\" lang=\"en\" xml:lang=\"en\">   <head>     <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />     <meta http-equiv=\"Content-Style-Type\" content=\"text/css\" />  <title>OCW Tool</title>";
	...
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(OCWTool.class);
