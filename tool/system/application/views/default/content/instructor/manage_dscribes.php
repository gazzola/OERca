...
<div id="tool_content">
	...
	<fieldset>
		...
		<form name="adminform" method="post" onsubmit="return isFormValid();" 
			  action="<?php echo site_url("instructor/dscribes/$cid")?>" style="margin:0px;">
		...
		<table>
			<tr>
				...
				<td><input type="text" required="1" name="name" tabindex="1" size="20" /></td>
			</tr>
			<tr>
				<th style="text-align: right">
				...
				<td>
					<input type="text" id="email" name="email" validate="1" required="1" mask="email"
							tabindex="2" size="20" />
				</td>
			</tr>
			<tr>
				...
				<td><input type="text" required="1" id="username" name="username" tabindex="3" size="20" /></td>
			</tr>
			<tr>
				<th style="text-align: right">
					<?php echo $this->lang->line('ocw_ins_dscribes_level')?>: &nbsp;&nbsp;
				</th>
				<td>
					<select name="level">
						<option value="dscribe1">dScribe 1</option>
						<option value="dscribe2">dScribe 2</option>
					</select>
				</td>
			</tr>
			<tr>
