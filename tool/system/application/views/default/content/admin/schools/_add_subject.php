...
<h2>Add a Subject for <?=$sname?></h2>

<form name="adminform" method="post" action="<?php echo site_url("admin/subjects/add_subject/$sid")?>" enctype="multipart/form-data" style="margin:0px;">

	<table>
    <tr>
      <th style="text-align:right"><span style="color:red">*</span> Code: &nbsp;&nbsp;</th>
      <td><input type="text" id="subj_code"  name="subj_code" tabindex="1" size="40" /></td>
    </tr>

    <tr>
			<th style="text-align:right"><span style="color:red">*</span> Description: &nbsp;&nbsp;</th>
			<td><input type="text" id="subj_desc" name="subj_desc" tabindex="2" size="40" /></td>
		</tr>
		
		<tr>
			<th></th>
			<td><input id="submitbutton" type="submit" name="submit" value="Add Subject" /></td>
		</tr>
 	</table>
