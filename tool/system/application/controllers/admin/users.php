...
{	
    ...
    function Users()
    {
        ...
        $this->_container = $this->config->item('FAL_template_dir').'admin/container';
		...
		$fields['name'] = $this->lang->line('FAL_name_label');
    ...
    function index()
    {
		...
		$data['page'] = $this->config->item('FAL_template_dir').'admin/users/list';
    ...
    {	    			
        ...
        else 
        {
	    	...
	    	$data['controller'] = 'users';
	    	$data['page'] = $this->config->item('FAL_template_dir').'admin/users/detail';
    ...
    {      
        ...
        if ($this->fal_validation->run() == FALSE)
		{
	    	...
	    	$data['controller'] = 'users';
	    	$data ['page'] = $this->config->item('FAL_template_dir').'admin/users/add';
    ...
    function edit($id = '')
    {
		...
		if ($this->fal_validation->run() == FALSE)
        {
	        	...
	        	$data['controller'] = 'users';
	        	$data ['page'] = $this->config->item('FAL_template_dir').'admin/users/edit';
    ...
    function _get_form_values()
    {
        ...
        $values['user']['name'] = $this->input->post('name', TRUE);
