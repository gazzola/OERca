    ...
    */
    function Freakauth_light()
    {
        ...
        if($this->CI->config->item('FAL_create_user_profile'))
            $this->CI->load->model('FreakAuth_light/Userprofile', 'userprofile');
    ...
    function _init()
    {
    	...
    	if (!$this->CI->config->item('FAL'))
    	{
            ...
            echo $this->CI->load->view($this->CI->config->item('FAL_template_dir').'turned_off', $data, true);
            exit;
    	}
    ...
    function register()
    {
        ...
        {	
            ...
            if (($username != false) && ($password != false) && ($email != false) && ($name != false))
            {
    ...
    {
        $values['name'] = $this->CI->input->post('name');
    ...
    {
        $values['name'] = $this->CI->input->post('name', TRUE);
