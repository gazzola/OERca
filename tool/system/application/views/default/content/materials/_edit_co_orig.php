...
<ul id="orig-accordion">
	...
	<!-- INFORMATION -->
	<li>
 		<h3><a name="oinformation" href="#oinformation">Information</a><span>+</span></h3>
  	<div class="column span-17 first last collapse">
			<div class="collapse-container">
  ...
  <!-- COPYRIGHT -->
 	<li>
		<h3><a name="ocopyright" href="#ocopyright">Copyright</a><span>+</span></h3>
  	<div class="column span-17 first last collapse">
		<div class="collapse-container">
		<table width="100%">
				<tr>
  ...
  <!-- LOGS -->
	<li>
 		<h3><a name="ologs" href="#ologs">Logs</a><span>+</span></h3>
  	<div class="column span-17 first last collapse">
			<div class="collapse-container">
		 	<div id="objectlog">
			<br/>
