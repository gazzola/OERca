...
+---------------------*/
 ...
 |
 */
 $config['FAL_website_name']    = "http://{$_SERVER['HTTP_HOST']}/ocw_tool";
 ...
 |
 */
 $config['FAL_user_support'] = 'dkhutch@umich.edu';
 ...
 */
 ...
 |
 */
 $config['FAL_denied_page'] = 'login/denied';
 ...
 */
 ...
 |------------------------------------------------------------------------------
 */
 $config['FAL_user_name_min'] = 3;       //min username length
 $config['FAL_user_name_max'] = 16;      //max username length
 $config['FAL_user_password_min'] = 5;   //min password length
 ...
 */
 $config['FAL_assets'] = 'assets'; //main assets folder
 $config['FAL_css'] = 'css';
 $config['FAL_images'] = 'images';
 $config['FAL_js'] = 'script';
 $config['FAL_assets_shared'] = $config['FAL_assets'].'/shared'; //shared assets
 $config['FAL_assets_front'] = $config['FAL_assets'].'/default'; //admin frontend
...
$config['FAL_captcha_base_image_path'] = $config['FAL_assets'].'/default/'.$config['FAL_images'].'/captcha/';
...
+----------------*/
 ...
 |
 */
 $config['FAL_template_dir'] = 'default/content/';

 // LOGIN
  // The view to display the login form
  $config['FAL_login_view'] = $config['FAL_template_dir'].'auth/forms/login';

 // REGISTRATION
  // view to display the user registration form
  $config['FAL_register_view'] = $config['FAL_template_dir'].'auth/forms/register';
  
  // view to display the successful registration information
  $config['FAL_register_success_view'] = $config['FAL_template_dir'].'auth/register_success';
  
  // view to display the successful activation information
  $config['FAL_register_activation_success_view'] = $config['FAL_template_dir'].'auth/activation_success';
  
  // view to display the failed activation information
  $config['FAL_register_activation_failed_view'] = $config['FAL_template_dir'].'auth/activation_failed';

 // FORGOTTEN PASSWORD
  // view to display the forgotten password form
  $config['FAL_forgotten_password_view'] = $config['FAL_template_dir'].'auth/forms/forgotten_password';
  
  // view to display the successful forgotten password request
  $config['FAL_forgotten_password_success_view'] = $config['FAL_template_dir'].'auth/forgotten_password_success';
  
  // view to display the successful forgotten password reset
  $config['FAL_forgotten_password_reset_success_view'] = $config['FAL_template_dir'].'auth/forgotten_password_reset_success';
  
  // view to display the failed forgotten password reset
  $config['FAL_forgotten_password_reset_failed_view'] = $config['FAL_template_dir'].'auth/forgotten_password_reset_failed';

 // CHANGE PASSWORD
  // view to display the forgotten password form
  $config['FAL_change_password_view'] = $config['FAL_template_dir'].'auth/forms/change_password';
  
 // CAPTCHA VIEW
  $config['FAL_captcha_img_tag_view'] = $config['FAL_template_dir'].'auth/forms/html_for_captcha';
...
+--------------------------*/
 ...
 $config['FAL_email_from'] = 'OCW Manager';
 
 // The location of the activation email
 $config['FAL_activation_email'] = $config['FAL_template_dir'].'auth/email/activation_email';
 
 // The location of the forgotten password email
 $config['FAL_forgotten_password_email'] = $config['FAL_template_dir'].'auth/email/forgotten_password_email';
 
 // The location of the forgotten password reset email
 $config['FAL_forgotten_password_reset_email'] = $config['FAL_template_dir'].'auth/email/forgotten_password_reset_email';
 
 // View to send by email for the change password informations
 $config['FAL_change_password_email'] = $config['FAL_template_dir'].'auth/email/change_password_email';
...
+-------------------*/
 ...
 $config['FAL_logout_success_action'] = 'auth';
...
$config['FAL_admin_logout_success_action'] = 'home';
