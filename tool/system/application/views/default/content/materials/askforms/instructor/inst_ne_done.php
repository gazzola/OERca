...
<td style="vertical-align:top; width: 300px; padding: 10px;">
  <p>
	<?=$this->ocw_utils->create_co_img($cid,$mid,$obj['id'],$obj['location'],'orig',true,true,true);?>
  </p>
...
<td style="vertical-align:top">
	<?=$this->ocw_utils->create_co_img($cid,$mid,$obj['object_id'],$obj['location'],'orig',true,true,true);?>
