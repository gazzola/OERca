...
<?php if ($courses == null || !isset($courses) ) { ?>
	...
	<p class="error">No courses found:&nbsp;&nbsp;<a href="<?=site_url("courses/add_new_course/")?>?TB_iframe=true&height=675&width=875" class="smoothbox" title="Add a new Course" style="color:blue">Add a Course</a></p>
