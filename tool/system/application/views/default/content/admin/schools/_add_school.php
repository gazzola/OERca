...
<form name="adminform" method="post" action="<?php echo site_url("admin/schools/add_school")?>" enctype="multipart/form-data" style="margin:0px;">
    ...
    <tr>
		...
		<tr>
			<th></th>
			<td><input id="submitbutton" type="submit" name="submit" value="Add School" /></td>
		</tr>
 	</table>
