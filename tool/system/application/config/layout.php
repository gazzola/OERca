...
$config['app_views_abspath']  = $_SERVER['DOCUMENT_ROOT']."/oerbob/system/application/views/default/content";
...
$config['app_fonts']  = $_SERVER['DOCUMENT_ROOT'].'/oerbob/'.$config['assets_folder'].'/'.$config['assets_design'].'/fonts/';
$config['app_uploads_url']  = site_url().'uploads/';
$config['app_uploads_path']  = $_SERVER['DOCUMENT_ROOT'].'/oerbob/uploads/';
$config['app_site_url']  = site_url();
$config['app_co_upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/oerbob/tmp/couploads/';
$config['app_mat_upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/oerbob/tmp/matuploads/';
