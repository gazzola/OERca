...
<div id="new-col2-<?=$obj['id']?>" style="display: <?=($obj['ask_status']=='in progress') ? 'none':'block'?>;">
	<?=$this->ocw_utils->create_co_img($cid,$mid,$obj['id'],$obj['location'],'ask:orig','orig',false);?>
<br/> <br/>
</div>


<div id="inprogress-col2-<?=$obj['id']?>" style="display: <?=($obj['ask_status']=='in progress') ? 'block':'none'?>;">
  <?=$this->ocw_utils->create_co_img($cid,$mid,$obj['id'],$obj['location'],'ask:orig','orig',true);?><br/>
</div>
</td>
</tr>	
<?php
